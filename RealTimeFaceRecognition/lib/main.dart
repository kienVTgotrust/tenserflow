...
void doFaceDetectionOnFrame() async {
  ...
  // Chuyển đổi CameraImage thành img.Image
  img.Image image;
  ...
  final recognitions = recognizer.recognize(image, Rect.zero);

  // Cập nhật danh sách nhận diện và gọi setState để làm mới UI
  setState(() {
...
Widget buildResult() {
  if (recognitions.isEmpty || controller == null || !controller.value.isInitialized) {
  ...
  return CustomPaint(
    painter: FaceDetectorPainter(imageSize, recognitions, camDirec),
  );
}
